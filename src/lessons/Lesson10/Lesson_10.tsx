...
function Lesson_10() {
  ...
  // const GET_UNIVERSITIES_URL: string = `http://unisities.hipolabs.com/search?country=${searchInputCountry}`;
  ...
  const uniCards = universities.map((university: University) => {
    return (
      <StyledCard key={v4()}>
        <p>
        ...
        <p>
          ...
          <a
            target="_blank"
            href={university.web_pages && university.web_pages[0]}
          >
            {university.web_pages && university.web_pages[0]}
          </a>
        </p>
      </StyledCard>
    );
